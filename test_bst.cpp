...
// Empty Testing
// 1. Test an empty BST
// 2. Insert into BST, test empty
// 3. Remove all elements from BST, test empty
// 4. DIfferent data types and data/key values?
//   a. int
//   b. float
//   c. string
//   d. negative keys
...
// Insert Testing
// 1. Insert into empty BST
// 2. Insert into alrady made BST
// 3. Remove from BST and then insert into BST, test
// 4. DIfferent data types and data/key values
//   a. int data and int key
//   b. float data and float key
//   c. string data and string key
//   d. negative keys and negative data
void test_insert() {
    try {
        BST<string, int> bst;
        bst.insert("one", 1);
...
// Get Testing
// 1. Test an empty BST
// 2. Insert into BST, test get
// 3. Remove all elements from BST, test get
// 4. DIfferent data types and data/key values
//   a. int data and int key
//   b. float data and float key
//   c. string data and string key
